...
def printTitle():
    print("""
 _______  __   __  _______    _______  _______  _______    __   __  _______  ______    _______  __   __  _______  __    _  _______ 
|       ||  | |  ||       |  |       ||       ||   _   |  |  |_|  ||       ||    _ |  |       ||  | |  ||   _   ||  |  | ||       |
|_     _||  |_|  ||    ___|  |  _____||    ___||  |_|  |  |       ||    ___||   | ||  |       ||  |_|  ||  |_|  ||   |_| ||_     _|
  |   |  |       ||   |___   | |_____ |   |___ |       |  |       ||   |___ |   |_||_ |       ||       ||       ||       |  |   |  
  |   |  |       ||    ___|  |_____  ||    ___||       |  |       ||    ___||    __  ||      _||       ||       ||  _    |  |   |  
  |   |  |   _   ||   |___    _____| ||   |___ |   _   |  | ||_|| ||   |___ |   |  | ||     |_ |   _   ||   _   || | |   |  |   |  
  |___|  |__| |__||_______|  |_______||_______||__| |__|  |_|   |_||_______||___|  |_||_______||__| |__||__| |__||_|  |__|  |___|
""")
